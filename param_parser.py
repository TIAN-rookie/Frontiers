...
def parameter_parser():
    ...
    parser.add_argument('--graph-folder',
                        ...
                        help='Folder with graph pair jsons.') #default='./synthetic_data_V2/',
    parser.add_argument('--result-log',
                        type=str,
                        default='synthetic_data_V2.log',
                        help='save results file') #default='synthetic_data_V2.log'
    ...
    parser.add_argument('--number-of-nodes',
                        type=int,
                        default=200,
                        help='synthetic=200,w/d=100') #default=200
    parser.add_argument('--sub_size',
                        type=int,
                        default=3,
                        help='synthetic=3,w/d=2') #default=3
